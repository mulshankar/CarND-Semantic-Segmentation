...
# The network architecture referenced in this work (FCN8) - https://people.eecs.berkeley.edu/~jonlong/long_shelhamer_fcn.pdf
...
def run():
    ...
    with tf.Session() as sess:
        ...
        print('VGG model successfully loaded')

        
        #create fully convolutional network and output the last layer
        nn_last_layer = layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes)
        
        print('extracted the last layer of the network - Success!')

        #calculate logits and cross entropy loss
        logits, train_op, cross_entropy_loss = optimize(nn_last_layer, correct_label, learning_rate, num_classes)
        
        print('Logits and cross entropy loss calculation defined')
